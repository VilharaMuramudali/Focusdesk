...
export default function Messages() {
  const { conversations, unreadCount, isConnected } = useChat();
  ...
  return (
    <div className="home-overview">
      <div className="container">
        <SharedHeaderBanner 
          title="Messages"
          subtitle="Stay connected with your tutors and peers"
        />
          ...
          <div className="messages-content">
            {conversations.length === 0 ? (
              <div className="no-messages">
                ...
                <p>Start chatting with your tutors to get help with your studies</p>
          ...
          <div className="messages-actions">
            <div className="action-cards">
              <div className="action-card">
                ...
                <h4>Quick Chat</h4>
                <p>Start a new conversation with any tutor</p>
